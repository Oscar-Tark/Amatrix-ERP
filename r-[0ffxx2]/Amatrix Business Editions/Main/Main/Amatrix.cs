...
namespace Main
{
    ...
    { 
        ...
        public static Extern_ASQL.Extern_Sql asql;
        public static Base_ASQL.BASQL basql;
        ...
        private ToolStripMenuItem icn_setlink(ToolStripMenuItem tsi, int ndx)
        {
            ...
            catch { try { sicn = tsi.ToolTipText; } catch { tsi.Image = Properties.Resources.file_link; } }
            try
            {
        ...
        private void th_init_strt_()
        {
            ...
            catch { if (bkk_init.IsBusy == true) { bkk_init.CancelAsync(); } else { Inint(); } }
        }
        ...
        protected void Inint()
        {
            ...
            //object init
            asql = new Extern_ASQL.Extern_Sql();
            basql = new Base_ASQL.BASQL();
