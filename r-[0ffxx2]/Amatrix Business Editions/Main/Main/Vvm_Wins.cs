...
namespace Main
{
    public partial class Vvm_Wins : Form
    {
        ...
        void pctre_MouseEnter(object sender, EventArgs e)
        {
            ...
            {
                timer2.Stop();
                Application.OpenForms[flp.Controls.IndexOf((PictureBox)sender)].WindowState = FormWindowState.Normal;
                Application.OpenForms[flp.Controls.IndexOf((PictureBox)sender)].Select();
            }
            catch { }
        }
