...
namespace Main
{
    public partial class mgmt_hr : Form
    {
        ...
        public mgmt_hr()
        {
            ...
            InitializeComponent();
            this.Text = "Amatrix Human Resource Managment";
        ...
        void mgmt_hr_Disposed(object sender, EventArgs e)
        {
           ...
           // button2.Click -= button2_Click_1;
            ...
            this.tabPage8.MouseLeave -= this.tvtxt1_MouseLeave;
            this.tabPage8.MouseEnter -= this.tvtxt1_MouseEnter;
            ...
            this.button20.Click -= this.button4_Click;
            ...
            this.textBox42.Enter -= this.gp_Enter;
        ...
        private void bttn_sync_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception erty) { bttn_sync.BackColor = Color.DarkOrange; this.Enabled = true; this.Text = this.Text.Replace(" [Synchronizing]", ""); }
        }
